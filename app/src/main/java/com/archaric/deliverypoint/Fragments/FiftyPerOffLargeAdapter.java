...
public class FiftyPerOffLargeAdapter extends RecyclerView.Adapter<FiftyPerOffLargeAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fifty_per_off_large_view,parent,false);
