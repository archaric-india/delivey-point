...
public class SpecialOffersAdapterLargeView extends RecyclerView.Adapter<SpecialOffersAdapterLargeView.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.special_offers_large_view,parent,false);
